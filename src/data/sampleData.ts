...
export const SAMPLE_MENU_ITEMS = [
  ...
  },
  {
    id: '7',
    name: 'Turkey Leg',
    description: 'Giant smoked turkey leg with our special seasoning.',
    price: 15.00,
    category: 'plates',
    ...
    stock: 10,
    featured: true,
    ingredients: ['Turkey leg', 'BBQ seasoning'],
    nutritionalInfo: {
      calories: 650,
      protein: 55,
      carbs: 5,
  ...
  },
  {
    id: '8',
    name: 'Baked Potato',
    description: 'Large baked potato loaded with butter, sour cream, cheese, and your choice of meat.',
    price: 20.00,
    category: 'sides',
    ...
    stock: 15,
    featured: false,
    ingredients: ['Potato', 'Butter', 'Sour cream', 'Cheese', 'Choice of meat'],
    nutritionalInfo: {
      calories: 750,
      protein: 25,
      carbs: 65,
