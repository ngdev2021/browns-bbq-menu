...
export const SAMPLE_MENU_ITEMS = [
  ...
  },
  {
    id: '7',
    name: 'Turkey Leg',
    description: 'Giant smoked turkey leg with our special seasoning. Can be loaded with butter, cheese, and sour cream (+$3).',
    price: 15.00,
    category: 'plates',
    ...
    stock: 10,
    featured: true,
    ingredients: ['Turkey leg', 'BBQ seasoning', 'Optional: butter, cheese, sour cream'],
    nutritionalInfo: {
      calories: 650,
      protein: 55,
      carbs: 5,
